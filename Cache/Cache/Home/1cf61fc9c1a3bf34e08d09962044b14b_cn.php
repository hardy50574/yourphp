...
</script></div><div class="warp"><div id="main"><div class="c"></div><div class="left"><ul id="lei_box"><li id="lei_25" class="first file"><span class="fl_ico"></span><a href="/phnom/" title="金边市"><span class="fl">金边市</span></a></li><li id="lei_26" class="foot file"><span class="fl_ico"></span><a href="/westport/" title="西港市"><span class="fl">西港市</span></a></li></ul><div class="list pic_list"><ul class="pic"><?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li><span><a href="<?php echo ($vo["url"]); ?>"><img src="<?php echo ($vo["thumb"]); ?>"></a></span><a href="<?php echo ($vo["url"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></div><div id="pages" class="page"><?php echo ($pages); ?></div><br></div><script>var subnav = document.getElementById('lei_<?php echo ($catid); ?>');
